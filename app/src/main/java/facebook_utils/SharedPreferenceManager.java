...
public class SharedPreferenceManager {
    ...
    public UserModel getUserModelFromPreferences()
    {
        ...
        String name = getStringFromPreferences(AppConstants.SharedPreferenceKeys.USER_NAME.getKey());
        if(!TextUtils.isEmpty(name)) {
            userModel = new UserModel();
            userModel.userName = name;
            userModel.userEmail = getStringFromPreferences(AppConstants.SharedPreferenceKeys.USER_EMAIL.getKey());
            userModel.profilePic = getStringFromPreferences(AppConstants.SharedPreferenceKeys.USER_IMAGE_URL.getKey());
